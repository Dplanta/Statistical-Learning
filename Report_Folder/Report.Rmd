...
print(paste("MSE of the reduced linear model with square root Salary = ", format(mse.lm.ess.sqrt, scientific = TRUE)))

print(paste("MSE square root of the reduced linear model with square root Salary = ",format(sqrt(mse.lm.ess.sqrt), scientific=TRUE)))
...
lm.ess.tables <- create_tables(y, lm.ess.pred.sqrt^2, final_dataset, 10)
