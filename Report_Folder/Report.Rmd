...
*perchè data regular season e non playoff*
...
BPM and VORP are calculated per 100 possessions; MIN is a total stat for the whole regular season, MIN_G is calculated per game. The other stats are considered per 48 minutes. (vedi WS)
